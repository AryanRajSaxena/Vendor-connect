...
export default function AddProductPage() {
  ...
  const handlePublish = async () => {
    try {
      ...
      if (!formData.name.trim() || !formData.description.trim() || !formData.basePrice) {
        throw new Error('Please fill in all required fields (name, description, price)');
      }
  ...
  return (
    <div className="px-6 py-8 max-w-5xl mx-auto">
      {/* Header */}
      <div className="mb-8">
        <h1 className="text-2xl font-bold text-gray-900">List a New Course</h1>
        <p className="text-sm text-gray-500 mt-1">
          Fill in all the details below to publish your course on the marketplace. The more complete, the better!
        </p>
      </div>

      {success && (
        <div className="bg-green-50 border border-green-200 text-green-700 text-sm px-4 py-3 rounded-lg mb-6">
          ✓ Course listed successfully! Redirecting...
        </div>
      )}
      {error && (
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <textarea
                  ...
                  placeholder="Describe what the learner will get, what they'll learn, and why it's valuable..."
                  rows={4}
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  placeholder="e.g. 4 weeks, 20 hours, 30 days, or Self-paced"
                  className="w-full px-3.5 py-2.5 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
                />
              </div>
            </div>
